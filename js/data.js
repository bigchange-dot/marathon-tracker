...
const PLANS = [
  ...
  { id: 'w06-fri', week: 6,  date: '2026-09-18', type: 'buildup',  targetKm: 8, note: '케이던스 175spm 의식. 보폭을 늘리지 말고 회전수로 올린다 — 오버스트라이드가 정강이를 때린다.' },
  ...
  { id: 'w10-mon', week: 10, date: '2026-10-19', type: 'long',     targetKm: 28, capMin: 210, note: '피크 롱런 = 대회 리허설. 시작 시각·신발·젤·런워크 비율 전부 대회 세팅 — 월요일 오전을 확보 못 하면 10/18(일) 오전으로 당기고 일요일 보조 조깅은 생략. 마지막 5km 대회 페이스. 상한 3:30 — 도달하면 거리 남아도 종료. ★목표 점검: 마지막 5km 대회 페이스 구간이 "쉽다"고 느껴지고 전체를 6\'40"대로 소화했다면 대회 목표를 4:45로 하향 조정. 그 미만이면 4:48~4:55 유지 (4:30은 이번 사이클 무리 — 내년 봄 목표).' },
