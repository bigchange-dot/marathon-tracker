...
const PLANS = [
  ...
  { id: 'w10-sun', week: 10, date: '2026-10-18', type: 'long',     targetKm: 28, capMin: 210, session: '새벽/오전', note: '피크 롱런 = 대회 리허설. 시작 시각·신발·젤·런워크 비율 전부 대회 세팅. 마지막 5km 대회 페이스. 상한 3:30 — 도달하면 거리 남아도 종료.' },
